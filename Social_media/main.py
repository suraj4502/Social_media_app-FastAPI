...
async def root(response: Response):
    ...
    return (
        ...
        "</head>"
        "<body>"
        "<h1>Hello, Welcome to my Social Media app(Backend).</h1>"
        "<p><strong>How to use the app:</strong></p>"
        "<ol>"
        "<li>Go to <a href='https://social-media-app-fastapi.onrender.com/docs'>https://social-media-app-fastapi.onrender.com/docs</a></li>"
        "<li>Use the '/users' POST method to create a user. (passwords are hashed, so no one can see them even the developer.)</li>"
        "<li>Then login using the credentials.</li>"
        "<li>You can explore the Posts section:"
        "<ul>"
